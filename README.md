...
| [PixelAPI](https://pixelapi.dev) | AI image processing: background removal, product photography, image generation (FLUX/SDXL), upscaling, virtual try-on | `apiKey` | Yes | Yes |
